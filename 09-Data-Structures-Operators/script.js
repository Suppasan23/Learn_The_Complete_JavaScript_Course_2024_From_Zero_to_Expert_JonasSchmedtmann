...
const users = [
  {
    name: "Suppasan",
    age: 31,
    email1: "suppasan_benz@outlook.com",
    email2: "suppasan.benz@gmail.com",
    email3: undefined,
  },
];

console.log(users[0]?.name ?? "User doesn't exist");
console.log(users[0]?.email3 ?? "User doesn't exist"); */
...
console.log("-----AND-----");
console.log(0 && "Suppasan");
console.log(7 && "Suppasan");
console.log(undefined && "Suppasan");
console.log(true && "Suppasan");

console.log("hello" && 23 && null && "Suppasan");
...
//1
const whoScored = Object.entries(game.scored);

for (const [i, player] of whoScored) {
...
for (const who of Object.values(game.scored)) {
  scorers[who] ? scorers[who]++ : (scorers[who] = 1);
}
